...
function thirdFunction(f = 2, g = f) {
	console.log(f * g);
}

thirdFunction(); //Выведет 4
...
function calculateYearsSinceLastOlympics(current, olimpicsYear) {
    return current - olimpicsYear;
}

console.log(
    'С момента летней олимпиады в Токио прошло ' + calculateYearsSinceLastOlympics(currentYear, 2020) + ' года',
);
